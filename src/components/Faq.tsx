const FAQS = [
  ...
  {
    q: "Will the game actually rival the big open worlds?",
    a: "That's the experiment. Claude Fable 5's standing instruction is to keep looping until the world surpasses the best open worlds in the genre. Whether the agents can get there — and how far the tokens go — is exactly what this page exists to watch.",
  },
  {
